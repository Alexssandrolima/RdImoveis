...
namespace Rd_Imoveis.Controlles.ADO
{
    class DaoAcesso
    {
        ...
        internal static object MySql_PegarUsuarioseAdmin(string receberDadosTabela, ClsObjetoTabela tabeladedados, bool Logadonosistemaretorno)
        {
            using (SqlConnection conexaoMySql = Controlles.ADO.DaoBaseAcessoMysql.PegarInstancia().PegarConexaoSQL())
            {
                try
                {
        ...
        public static DataTable MySql_PegarDados(string receberDadosTabela)  //metodo de chamar os dados da classe RECEBER /// cliente/produtos.
        {
            using (SqlConnection conexaoMySql = Controlles.ADO.DaoBaseAcessoMysql.PegarInstancia().PegarConexaoSQL())
            {
                try
        ...
        internal static object MySql_PegarDadosUnitario(string receberDadosTabela, int NumerodoId)
        {
            using (SqlConnection conexaoMySql = Controlles.ADO.DaoBaseAcessoMysql.PegarInstancia().PegarConexaoSQL())
            {
                try
        ...
        public static DataTable MySql_PegarSepararDados(string colunasdatabela)  //metodo de chamar os dados da classe RECEBER /// cliente/produtos.
        {
            using (SqlConnection conexaoMySql = Controlles.ADO.DaoBaseAcessoMysql.PegarInstancia().PegarConexaoSQL())
            {
        ...
        //        public static string pegaradministradordosistema { Pegar; set; }
        ...
        //internal static object MySql_PegarSepararDados(string colunasdatabela, string tabeladbf)
        //{

        //    using (FbConnection conexaoMySql = Controlles.ADO.DaoBaseAcessoMysql.PegarInstancia().PegarConexaoFB())
        //    {
        //        try
        //        {
        //            //ClsObjetoTabela tabeladedados = new ClsObjetoTabela();
